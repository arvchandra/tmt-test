...
# Custom pagination class (to define page size as 3 items)
class CustomInventoryPagination(LimitOffsetPagination):
    default_limit = 3 
    max_limit = 3
...
class InventoryListCreateView(APIView):
    ...
    pagination_class = CustomInventoryPagination
    ...
    def get(self, request: Request, *args, **kwargs) -> Response:
        ...
        # Serialize the paginated inventory list.
